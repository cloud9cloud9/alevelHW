package ua.nalezhytyi.hw19b.task4;

import com.mongodb.client.*;
import com.mongodb.client.result.DeleteResult;
import org.bson.Document;
import org.bson.conversions.Bson;
import ua.nalezhytyi.hw19.task4.Address;

public class MongoExample {
    public static void main(String[] args) {
        MongoCollection<Document> table = createTable(getConnection());
        ua.nalezhytyi.hw19.task4.Address address = new ua.nalezhytyi.hw19.task4.Address("New York", "Brain st.");
